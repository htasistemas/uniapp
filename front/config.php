...
<style>
    ...
    .colors-section { background-color: #f9f9f9; border: 1px solid #eee; padding: 15px; border-radius: 4px; width: 100%; max-width: 600px; }
...
<div class="uniapp-container">
    ...
    <form method="post" action="<?php echo htmlspecialchars($SELFURL); ?>" class="uniapp-form">
        ...
        <div class="form-group">
            <div class="label-col"><label>Personalização visual</label></div>
            <div class="input-col">
                <div class="colors-section">
                    <?php
                    $colors = [
                        'color_header'     => 'Cor do cabeçalho',
